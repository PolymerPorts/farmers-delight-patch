...
import eu.pb4.farmersdelightpatch.impl.res.*;
...
public class FarmersDelightPolymerPatch implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        BooleanProperty.TYPES.put(FarmersDelight.id("skillet/is_cooking"), SkilletCookingConditionalItemModelProperty.MAP_CODEC);
        SpecialModel.TYPES.put(FarmersDelight.id("skillet"), SkilletSpecialModel.CODEC);
        ItemModel.TYPES.put(FarmersDelight.id("skillet_flip"), SkilletFlipItemModel.CODEC);
